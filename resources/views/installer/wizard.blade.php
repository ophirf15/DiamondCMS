...
@section('content')
    @php
        $boot = [
            ...
            'defaults' => [
                'db_host' => old('db_host', session('installer.db.db_host', '127.0.0.1')),
                'db_port' => (string) old('db_port', session('installer.db.db_port', '3306')),
                'db_database' => old('db_database', session('installer.db.db_database', 'diamondcms')),
                'db_username' => old('db_username', session('installer.db.db_username', 'diamondcms')),
                'db_password' => old('db_password', session('installer.db.db_password', 'diamondcms_local')),
